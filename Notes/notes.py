...
first_message = "if you want to change or remove note, you should search it first."
...
def note_search():
    if len(os.listdir(dir_path)) == 0:
        ...
        if str(check_que).lower() == "yes":
            ...
            additional_operations = [[1, "Edit note", lambda: edit_note(cur_note)],
